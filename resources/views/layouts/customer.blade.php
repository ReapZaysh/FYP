            ...
            <div class="flex justify-between py-2">
                ...
                <div class="flex items-center">
                    <a href="{{ route('customer.cart') }}" class="relative p-2 text-gray-500 hover:text-gray-700">
                        ...
                        @if($count > 0)
                            <span
                                class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/4 -translate-y-1/4 bg-red-600 rounded-full">{{ $count }}</span>
                        @endif
                    </a>
                </div>
            </div>
