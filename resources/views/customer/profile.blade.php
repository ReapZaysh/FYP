            ...
            <div class="flex flex-col md:flex-row items-center gap-8 relative z-10">
                ...
                <div class="flex-grow text-center md:text-left">
                    ...
                    @if(isset($user->phone) && $user->phone)
                        <p class="text-gray-400 font-medium mb-4">{{ $user->phone }}</p>
                    @else
                        <div class="mb-4"></div>
                    @endif
                    <div class="flex items-center gap-3 justify-center md:justify-start">
                        ...
                        <a href="{{ route('customer.profile.edit') }}" class="inline-flex items-center gap-1 px-4 py-1.5 bg-white/20 hover:bg-white/30 rounded-full text-xs font-bold text-white transition-colors">
